...
local outCombat = {
	...
	{'2823', { -- Deadly Poison / Letal
		'!lastcast(2823)',
		'!player.buff(2823)',
		(function() return NeP.Core.PeFetch('NePConfigRogueSub', 'LetalPosion') == 'Deadly' end)
	}},
	{'8679', { -- Deadly Poison / Letal
		'!lastcast(8679)',
		'!player.buff(8679)',
		(function() return NeP.Core.PeFetch('NePConfigRogueSub', 'LetalPosion') == 'Wound' end)
	}},
	...
	{'3408', { -- Crippling Poison / Non-Letal
		'!lastcast(3408)',
		'!player.buff(3408)',
		(function() return NeP.Core.PeFetch('NePConfigRogueSub', 'NoLetalPosion') == 'Crippling' end)
	}},
	{'108211', { -- Leeching Poison / Non-Letal
		'!lastcast(108211)',
		'!player.buff(108211)',
		(function() return NeP.Core.PeFetch('NePConfigRogueSub', 'NoLetalPosion') == 'Leeching' end)
	}}
}
...
ProbablyEngine.rotation.register_custom(261, NeP.Core.GetCrInfo('Rogue - Subtlety'), 
	{-- In-Combat
		{{ -- Dont Break Sealth && Melee Range
			...
			{AoE, (function() return NeP.Core.SAoE(3, 10) end) },
