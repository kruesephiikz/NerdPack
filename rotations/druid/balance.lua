NeP.Interface.classGUIs[102] = {
	...
	config = {
		...
		{ type = "header", text = "General settings:", align = "center" },
			...
			-- Form in-combat
			{type = "dropdown", text = "Form", key = "Form",
				list = {
					{text = "Cat",key = "2"},
					{text = "Bear",key = "1"},
					{text = "Travel",key = "3"},
...
local _All = {
	-- Buff
	{ "#Empowered Augment Rune", "!player.buff(175457)" },
...
local BoomkinForm = {
	...
	{{ -- Auto Dotting
		{ "164812", (function() return NeP.Core.AutoDots("164812", 2) end) }, -- moonfire
		{ "164815", (function() return NeP.Core.AutoDots("164815", 2) end) }, --SunFire
