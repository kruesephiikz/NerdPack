...
local inCombat = {
	...
	-- AoE
	{ '84714', (function() return NeP.Core.SAoE(3, 40) end) },--Frozen Orb
	{ 'Ice Nova', { 
		(function() return NeP.Core.SAoE(3, 40) end), 
		'talent(5, 3)' 
	}},
	{ '120', (function() return NeP.Core.SAoE(3, 40) end) },--Cone of Cold
	{ '10', (function() return NeP.Core.SAoE(3, 40) end), 'target.ground' },--Blizzard
