...
function StatusGUI_RUN()
	...
	NeP_Frame:SetPoint(NeP.Core.PeFetch("NePConf", "NePFramePos") or "TOP") 
	...
	statusGUI2:SetClampedToScreen(true)
	...
	statusGUIAlert:SetClampedToScreen(true)
	...
	statusGUI3:SetClampedToScreen(true)
