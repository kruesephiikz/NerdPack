...
local _objectTable = NeP.ObjectManager.unitCache
...
C_Timer.NewTicker(1, (function()
	...
	if _CacheShow then
		...
		_CacheGUI:SetTitle(_tittleGUI..' ObjectManager: Enemie Units List                                  |cffff0000TOTAL: '..#_objectTable)
