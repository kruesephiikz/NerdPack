...
local function getStatusBar()
    ...
    if not statusBar then
        ...
        statusBar.frame:SetStatusBarColor(DiesalTools:GetColor('000000'))
    end
    statusBar:Show()
...
local _objectTable = NeP.ObjectManager.objectsCache
...
C_Timer.NewTicker(1, (function()
	...
	if _CacheShow then
		...
		_CacheGUI:SetTitle(_tittleGUI..' ObjectManager: Enemie List                                      |cffff0000TOTAL: '..#_objectTable)
