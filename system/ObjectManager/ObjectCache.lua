...
---------------------------------------------------]]
local function addToOM(object, distance)
	-- Lumbermill
	...
	-- Ores
	elseif NeP_objectIsOre(Obj) then
		objectsCache[#objectsCache+1] = {
			key = object, 
			distance = distance, 
			health = 1, 
	...
	-- Herbs
	elseif NeP_objectIsHerb(Obj) then
		objectsCache[#objectsCache+1] = {
			key = object, 
			distance = distance, 
			health = 1, 
	...
	-- Fish
	elseif NeP_objectIsFish(Obj) then
		objectsCache[#objectsCache+1] = {
			key = object, 
			distance = distance, 
			health = 1, 
	...
	elseif UnitIsFriend("player", object) then
