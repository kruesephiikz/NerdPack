...
function OMGUI_RUN()
	...
	titleText3:SetPoint("TOPRIGHT", -65, -7)
	titleText3:SetText('')
	...
	-- Close Button
	CloseButton = NeP.Interface.addButton(NeP_OMLIST)
	...
	settingsButton:SetPoint("TOPRIGHT", -30, 0)
				...
				titleText3:SetText('|cffCCCCCC('.._Displaying..')')
					...
					titleText2:SetText('|cffff0000Total: '..#_objectTable)
						if #_objectTable > 0 then
							...
							local distance = NeP.Core.Round(Obj.distance) or ""
